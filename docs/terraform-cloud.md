...
The supported pattern is to run the `changegate` CLI from your own worker, CI job, or automation service that already has access to plan JSON. There is no hosted ChangeGate service.
