...
**12 findings**: 12 blocking, 0 warnings, 0 suppressed.

**Decision reasons**
- `MEETS_BLOCK_THRESHOLD` `aws_db_instance.customer`: attack path attack-path-ebb91706401c9280 meets critical/high threshold
