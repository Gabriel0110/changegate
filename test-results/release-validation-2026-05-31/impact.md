...
- `AWS_PUBLIC_TO_SENSITIVE_DATA_PATH` `critical/high` Public entrypoint aws_lb.admin reaches sensitive asset aws_db_instance.customer
  - attack path attack-path-ebb91706401c9280 produced block decision
  - attack path type is public_to_sensitive_data
